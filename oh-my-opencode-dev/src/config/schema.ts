...
export const ExperimentalConfigSchema = z.object({
  ...
  /** When true, plugin never calls client.provider.list() or client.model.list(); only uses local cache. Use for offline/air-gapped environments to avoid models.dev requests. */
